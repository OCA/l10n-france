...
MAPPING = {
    ...
    'ACH_UE_due-20.0': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_due-10.0': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_due-8.5': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_due-5.5': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_due-2.1': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_ded.-20.0': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_ded.-10.0': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_ded.-8.5': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_ded.-5.5': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'ACH_UE_ded.-2.1': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
    'EXO-0': {'categ': 'tax_categ_e', 'type': 'tax_type_vat'},
    'EXPORT-0': {'categ': 'tax_categ_g', 'type': 'tax_type_vat'},
    'UE-0': {'categ': 'tax_categ_ic', 'type': 'tax_type_vat'},
