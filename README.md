...
--- | --- | --- | ---
[account_banking_fr_lcr](account_banking_fr_lcr/) | 15.0.2.0.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Create French LCR CFONB files
...
[l10n_fr_chorus_account](l10n_fr_chorus_account/) | 15.0.1.3.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Generate Chorus-compliant e-invoices and transmit them via the Chorus API
