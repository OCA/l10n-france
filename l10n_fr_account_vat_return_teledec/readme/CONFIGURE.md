...
- the company bank account that will be used as the default bank account
  to pay VAT,
- the email (login) corresponding to your account in Teledec.fr
- select the legal representative of your company. This person must have
  a name, an email, a function and a title (mister or madam).
