...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-l10n_fr_account_invoice_import_facturx>=16.0dev,<16.1dev',
        'odoo-addon-l10n_fr_account_invoice_import_simple_pdf>=16.0dev,<16.1dev',
        ...
        'odoo-addon-l10n_fr_business_document_import>=16.0dev,<16.1dev',
