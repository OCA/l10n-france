...
class TestFECExportOCA(TestFECExport):
    def test_fec_export_with_user(self):
        user_demo = new_test_user(self.env, login="fec_test_user")
        self.init_invoice(
    ...
    def test_fec_export_with_partner_ref(self):
        ...
        self.assertEqual(
            ...
            "OUV|Balance initiale|OUVERTURE/2020|20200101|999998|Accumulated Retained Earnings|||-|20200101|/|0,00| 000000000003000,00|||20200101||\r\n"  # noqa: E501
            ...
            f"INV|Sales|INV/2020/00001|20200101|121000|Account Receivable|{self.partner_a.ref}|partner_a|-|20200101|INV/2020/00001| 000000000003000,00|0,00|||20200101| 000000000003000,00|USD",  # noqa: E501
        )
