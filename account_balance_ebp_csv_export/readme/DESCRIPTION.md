...
One of the possible usage scenario of this module is to export the trial balance to software dedicated to the [liasse fiscale](http://fr.wikipedia.org/wiki/Liasse_fiscale) (French fiscal declaration) that accept CSV files from the EBP accounting software. This file has been successfully tested with the following software:

* [Teledec](https://www.teledec.fr/), which is a SaaS solution for the *liasse fiscale* with support for EDI transmission
